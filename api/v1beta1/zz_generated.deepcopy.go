...
func (in *AIServiceBackendSpec) DeepCopyInto(out *AIServiceBackendSpec) {
	*out = *in
	...
	if in.HeaderValueFilters != nil {
		in, out := &in.HeaderValueFilters, &out.HeaderValueFilters
		*out = make([]HTTPHeaderValueFilter, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTPHeaderValueFilter) DeepCopyInto(out *HTTPHeaderValueFilter) {
	*out = *in
	if in.Values != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPHeaderValueFilter.
func (in *HTTPHeaderValueFilter) DeepCopy() *HTTPHeaderValueFilter {
	if in == nil {
		return nil
	}
	out := new(HTTPHeaderValueFilter)
	in.DeepCopyInto(out)
	return out
}
