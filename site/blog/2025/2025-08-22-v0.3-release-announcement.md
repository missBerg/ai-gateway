...
tags: [news, releases]
image: /img/blog/og/v0.3-release-announcement.png
description: Envoy AI Gateway v0.3 brings intelligent inference routing with Endpoint Picker, production-ready Google Vertex AI support, and enterprise observability with OpenInference tracing—transforming AI infrastructure from static to intelligent.
---

# Envoy AI Gateway v0.3: Intelligent Inference Routing and Production-Ready AI Infrastructure

![Envoy AI Gateway v0.3.0 Release](/img/blog/v0.3-hero.png)
