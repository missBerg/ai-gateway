...
title: Envoy AI Gateway v0.3 - Release Announcement
...
The **Envoy AI Gateway v0.3** release introduces **intelligent inference routing** through Endpoint Picker Provider (EPP) integration, expands our provider ecosystem with **Google Vertex AI production support**, and delivers **enterprise-grade observability** with OpenInference tracing.
...
- **Complete Gemini streaming support** with OpenAI API compatibility
- **Anthropic Claude integration** via GCP Vertex AI
...
*Envoy AI Gateway v0.3 is available now. For detailed release notes, API changes, and upgrade guidance, visit our [release notes page](http:///release-notes/v0.3).*
