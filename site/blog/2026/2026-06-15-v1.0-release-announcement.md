...
authors: [missberg, dansun, mathetake, aaronchoo, yaoweng, xunzhuo]
tags: [news, releases]
image: /img/blog/og/v1.0-release-announcement.png
description: >-
...
<!--
  ⚠️ PRE-RELEASE DRAFT — written ahead of the v1.0.0 cut. Before publishing:
  - TODO: rename this file to the real release date (filename date is a placeholder = drafting date).
  - TODO: confirm the exact version string and the API-stability claim below — specifically whether
          1.0 promotes the core CRDs from v1beta1 to v1 (the strongest GA signal). Adjust wording to match.
  - TODO: reconcile the "What's in 1.0" feature list against the actual v1.0 release notes.
  - TODO: replace /img/blog/v1.0-hero.png (currently a copy of the v0.3 hero) with a real 1.0 hero asset.
  - TODO: confirm permission before quoting any adopter; refresh community stats (stars/contributors).
-->

# Announcing Envoy AI Gateway 1.0 — A Stable, Production-Ready AI Gateway

![Announcing Envoy AI Gateway 1.0](/img/blog/v1.0-hero.png)
...
| ------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Stable CRDs**           | The resources you author — `AIGatewayRoute`, `AIServiceBackend`, `BackendSecurityPolicy`, `GatewayConfig`, `MCPRoute` — won't break under you. <!-- TODO: confirm exact served API version (v1beta1 vs v1) for 1.0 --> |
...
| **Control-plane API**            | v1alpha1 (experimental) | **Stable**                                                                                                                  |
...
<!-- TODO: finalize this list against the actual v1.0 release notes. The pillars below are the
     established, verified capabilities as of v0.7; trim/expand to match what actually ships in 1.0. -->
...
Tencent, and Nutanix**, alongside a growing roster of independent contributors who join our **weekly
...
Corporation, Alan by Comma Soft, and NRP**. <!-- TODO: confirm permission before quoting/expanding adopter list -->
