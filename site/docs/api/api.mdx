...
- [ModelPricingList](#modelpricinglist)
- [QuotaPolicy](#quotapolicy)
- [QuotaPolicyList](#quotapolicylist)
...
/><ApiField
  name="spec"
  type="[GatewayConfigSpec](#gatewayconfigspec)"
  required="true"
  description="Spec defines the configuration for the external processor."
/><ApiField
  name="status"
  type="[GatewayConfigStatus](#gatewayconfigstatus)"
  required="true"
...
/><ApiField
  name="items"
  type="[GatewayConfig](#gatewayconfig) array"
  required="true"
  description=""
/>
...
<ApiField
  ...
  type="String"
  required="true"
  description="This is a <code>ModelPricing</code> resource"
/>
...
/><ApiField
  name="spec"
  type="[ModelPricingSpec](#modelpricingspec)"
  required="true"
  description="Spec defines the details of the ModelPricing."
/><ApiField
  name="status"
  type="[ModelPricingStatus](#modelpricingstatus)"
  required="true"
  description="Status defines the status details of the ModelPricing."
/>
...
<ApiField
  ...
  type="String"
  required="true"
  description="This is a <code>ModelPricingList</code> resource"
/>
...
/><ApiField
  name="items"
  type="[ModelPricing](#modelpricing) array"
  required="true"
  description=""
/>
...
/><ApiField
  name="spec"
  type="[QuotaPolicySpec](#quotapolicyspec)"
  required="true"
  description=""
/><ApiField
  name="status"
  type="[QuotaPolicyStatus](#quotapolicystatus)"
  required="true"
...
/><ApiField
  name="items"
  type="[QuotaPolicy](#quotapolicy) array"
  required="true"
  description=""
/>
...
- [CostTransparencyConfig](#costtransparencyconfig)
...
- [ModelPricingSpec](#modelpricingspec)
- [ModelPricingStatus](#modelpricingstatus)
- [MonetaryQuotaValue](#monetaryquotavalue)
- [PerModelQuota](#permodelquota)
- [PricingFactors](#pricingfactors)
- [PricingOverride](#pricingoverride)
- [PricingRef](#pricingref)
- [ProtectedResourceMetadata](#protectedresourcemetadata)
- [QuotaBucketMode](#quotabucketmode)
- [QuotaDefinition](#quotadefinition)
- [QuotaPolicySpec](#quotapolicyspec)
- [QuotaPolicyStatus](#quotapolicystatus)
- [QuotaRule](#quotarule)
- [QuotaValue](#quotavalue)
- [ServiceQuotaDefinition](#servicequotadefinition)
- [ToolCall](#toolcall)
...
/><ApiField
  name="bodyMutation"
  type="[HTTPBodyMutation](#httpbodymutation)"
  required="false"
...
<ApiField
  ...
  required="true"
  defaultValue="false"
  description="Enabled turns on the administrator-side gate. Disabled by default."
/>
...
<ApiField
  name="extProc"
  type="[GatewayConfigExtProc](#gatewayconfigextproc)"
  required="false"
...
<ApiField
  name="set"
  type="[HTTPBodyField](#httpbodyfield) array"
  required="false"
...
<ApiField
  name="source"
  type="[MCPAuthorizationSource](#mcpauthorizationsource)"
  required="true"
...
<ApiField
  ...
  type="string"
  required="true"
  description="Name is the model identifier matched against the request model name<br />(after any modelNameOverride has been applied on the route)."
/><ApiField
  name="default"
  type="[PricingFactors](#pricingfactors)"
  required="true"
  description="Default contains the baseline pricing factors applied when no override<br />matches the request's resolved (region, tier) tuple."
/><ApiField
  name="overrides"
  type="[PricingOverride](#pricingoverride) array"
  required="false"
  description="Overrides expresses per-(region, tier) variance on top of Default. Each<br />override must specify at least one of region or tier; the canonical<br />matching key is `region\|tier` with empty strings acting as wildcards.<br />A pair (region, tier) may appear at most once."
/><ApiField
  name="extensionFactors"
  type="object (keys:string, values:string)"
  required="false"
  description="ExtensionFactors captures forward-compatible extension token classes<br />(e.g. provider-specific audio or image tokens) as decimal strings keyed<br />by the extension name. The data plane treats unknown extension keys as<br />zero-cost; operators opt in per provider."
/>
...
<ApiField
  ...
  type="string"
  required="true"
  description="Currency is the ISO-4217 currency code the pricing factors are denominated in.<br />All entries in this table share the same currency."
/><ApiField
  name="unit"
  type="string"
  required="true"
  description="Unit is the minor-unit the data plane will use for cost metadata values.<br />MicroDollar (10^-6 USD) is the default for USD. Use CentiDollar (10^-2 USD)<br />when a single request may accrue more than $1000 of cost, because Envoy<br />enforces a hits_addend ceiling of 1_000_000_000 per descriptor."
/><ApiField
  name="perMillionTokens"
  type="boolean"
  required="false"
  defaultValue="true"
  description="PerMillionTokens controls whether the factor values are expressed per<br />1M tokens (true, the default and recommended form) or per-token (false).<br />The controller performs any scaling required before emitting the pre-scaled<br />integer factors into the filter configuration."
/><ApiField
  name="defaultRegion"
  type="string"
  required="false"
  description="DefaultRegion is the region used for model lookup when a request does not<br />carry an explicit region (either via QuotaPolicy pricingRef.region or the<br />x-ai-eg-region header). Empty means `no regional default`."
/><ApiField
  name="defaultTier"
  type="string"
  required="false"
  description="DefaultTier is the service tier used for model lookup when a request does<br />not carry an explicit tier. Empty means `no tier default`."
/><ApiField
  name="models"
  type="[ModelPricingEntry](#modelpricingentry) array"
  required="true"
  description="Models lists the per-model pricing entries. Model names must be unique."
/>
...
<ApiField
  ...
  type="[Condition](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.29/#condition-v1-meta) array"
  required="true"
  description="Conditions is the list of conditions by the reconciliation result.<br />Known .status.conditions.type are: `Accepted`, `NotAccepted`."
/>
...
<ApiField
  ...
  type="integer"
  required="true"
  description="Amount is the limit allotted for the specified Duration, expressed in the<br />Unit declared below. For example, Amount=1_000_000 with Unit=MicroDollar<br />represents a $1.00 cap."
/><ApiField
  name="currency"
  type="string"
  required="true"
  description="Currency is the ISO-4217 currency code. Must match the currency declared<br />on the referenced ModelPricing."
/><ApiField
  name="unit"
  type="string"
  required="true"
  description="Unit is the minor currency unit the Amount is denominated in. Must match<br />the unit declared on the referenced ModelPricing."
/><ApiField
  name="duration"
  type="string"
  required="true"
  description="Duration is the time window over which Amount applies. Suffix units are:<br />* s - seconds<br />* m - minutes<br />* h - hours<br />* d - days"
/>
...
/><ApiField
  name="quota"
  type="[QuotaDefinition](#quotadefinition)"
  required="true"
...
<ApiField
  ...
  type="string"
  required="false"
  description="InputTokenCost is the per-1M-input-token cost, as a decimal string.<br />Example: `3.0` meaning $3.00 per 1M input tokens."
/><ApiField
  name="outputTokenCost"
  type="string"
  required="false"
  description="OutputTokenCost is the per-1M-output-token cost, as a decimal string."
/><ApiField
  name="cachedInputTokenCost"
  type="string"
  required="false"
  description="CachedInputTokenCost is the per-1M-cached-input-token cost, as a decimal string."
/><ApiField
  name="cacheCreationInputTokenCost"
  type="string"
  required="false"
  description="CacheCreationInputTokenCost is the per-1M-cache-creation-input-token cost, as a decimal string."
/><ApiField
  name="reasoningTokenCost"
  type="string"
  required="false"
  description="ReasoningTokenCost is the per-1M-reasoning-token cost, as a decimal string."
/>
...
<ApiField
  ...
  type="string"
  required="false"
  description="Region is the region this override applies to. Empty means `any region`."
/><ApiField
  name="tier"
  type="string"
  required="false"
  description="Tier is the service tier this override applies to. Empty means `any tier`."
/><ApiField
  name="inputTokenCost"
  type="string"
  required="false"
...
<ApiField
  ...
  type="string"
  required="true"
  description="Name is the name of the ModelPricing resource in the same namespace as<br />the QuotaPolicy."
/><ApiField
  name="region"
  type="string"
  required="false"
  description="Region pins the region used for factor lookup. Empty means `use request<br />header or pricing-table default`."
/><ApiField
  name="tier"
  type="string"
  required="false"
  description="Tier pins the service tier used for factor lookup. Empty means `use<br />request header or pricing-table default`."
/>
...
<ApiField
  ...
  type="enum"
  required="false"
  description="QuotaBucketModeShared charges the request against every matching bucket<br />(including the default). The request is allowed only when every matching<br />bucket has capacity.<br />"
/><ApiField
  name="Exclusive"
  type="enum"
  required="false"
  description="QuotaBucketModeExclusive charges the request against matching bucket rules<br />(or the default bucket when no rules match) and denies the request only<br />when all matching buckets are out of quota.<br />"
/><ApiField
  name="MostGenerous"
  type="enum"
  required="false"
  description="QuotaBucketModeMostGenerous charges the request against the single<br />matching bucket with the largest configured cap. Remaining matching<br />buckets are not touched. Ties are broken by declaration order.<br />"
/>
#### QuotaDefinition
...
/><ApiField
  name="mode"
  type="[QuotaBucketMode](#quotabucketmode)"
  required="true"
  description="The `Mode` determines how quota is charged to the `DefaultBucket` and matching `BucketRules`.<br />In the `exclusive` mode the quota is charged to matching BucketRules or the DefaultBucket<br />if no BucketRules match the request. The request is denied if all matching buckets are out of quota.<br />In the `shared` mode the quota is charged to all matching `BucketRules` AND the `DefaultBucket`<br />and request is allowed only if the quota is available in all matching buckets."
/><ApiField
  name="defaultBucket"
  type="[QuotaValue](#quotavalue)"
  required="false"
...
/><ApiField
  name="bucketRules"
  type="[QuotaRule](#quotarule) array"
  required="false"
  description="BucketRules are a list of client selectors and quotas. If a request<br />matches multiple rules, each of their associated quotas get applied, so a<br />single request might burn down the quota for multiple rules."
/>
...
/><ApiField
  name="serviceQuota"
  type="[ServiceQuotaDefinition](#servicequotadefinition)"
  required="false"
...
/><ApiField
  name="perModelQuotas"
  type="[PerModelQuota](#permodelquota) array"
  required="false"
  description="PerModelQuotas specifies quota for different models served by the AIServiceBackend(s) where this<br />policy is attached."
/><ApiField
  name="costTransparency"
  type="[CostTransparencyConfig](#costtransparencyconfig)"
  required="false"
  description="CostTransparency opts this policy into surfacing the computed per-request<br />cost back to the caller. Exposure is additionally gated by the caller<br />sending the `x-ai-eg-cost-visibility: true` request header, so that both<br />the administrator and the caller must agree before pricing is revealed.<br />Disabled by default."
/>
...
<ApiField
  ...
  type="[Condition](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.29/#condition-v1-meta) array"
  required="true"
  description="Conditions is the list of conditions by the reconciliation result.<br />Known .status.conditions.type are: `Accepted`, `NotAccepted`,<br />`PricingResolved`, `ModelNotPriced`, `BackendTrafficPolicyGenerated`."
/>
...
/><ApiField
  ...
  type="string"
  required="true"
  description="Time window. The suffix is used to specify units. The following<br />suffixes are supported:<br />* s - seconds (the default unit)<br />* m - minutes<br />* h - hours"
/>
...
<ApiField
  ...
  type="string"
  required="false"
  description="CostExpression specifies a CEL expression for computing the quota burndown of the LLM-related request.<br />If no expression is specified the `total_tokens` value is used.<br />For example:<br /> * `input_tokens + cached_input_tokens * 0.1 + output_tokens * 6`<br />CostExpression and PricingRef are mutually exclusive."
/><ApiField
  name="pricingRef"
  type="[PricingRef](#pricingref)"
  required="false"
  description="PricingRef selects a ModelPricing resource that drives money-denominated<br />cost computation for this quota. When set, the data plane uses the<br />referenced pricing table (along with optional region and tier) to compute<br />per-request cost in the unit declared on the pricing table, bypassing<br />CostExpression.<br />CostExpression and PricingRef are mutually exclusive."
/><ApiField
  name="quota"
  type="[QuotaValue](#quotavalue)"
  required="false"
  description="Quota value applicable to all requests.<br />A response with 429 HTTP status code is sent back to the client when<br />the selected requests have exceeded the quota.<br />Quota and MonetaryQuota are mutually exclusive."
/><ApiField
  name="monetaryQuota"
  type="[MonetaryQuotaValue](#monetaryquotavalue)"
  required="false"
  description="MonetaryQuota expresses the quota as an amount of currency in the unit<br />declared on the referenced ModelPricing table. Required when PricingRef<br />is set, and mutually exclusive with Quota."
/>
