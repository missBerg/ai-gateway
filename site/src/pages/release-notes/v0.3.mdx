...
1. **Migrate backendSecurityPolicy references** - Update from the deprecated `AIGatewayRoute.backendSecurityPolicyRef` pattern to the new `BackendSecurityPolicy.targetRefs` approach  after the upgrade to v0.3.0.
